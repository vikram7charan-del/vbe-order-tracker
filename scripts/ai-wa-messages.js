...
const TONES = [
  ...
  'दोस्ताना और अपनापन भरा',
  'छोटा और सीधा, professional',
  'हल्का Hinglish (हिंदी + थोड़ी English)',
  'गर्मजोशी वाला, प्रोत्साहन देने वाला',
  'शुद्ध हिंदी, शालीन',
];
...
व्यक्ति का नाम: ${name}
इनसे इन कामों के बारे में याद दिलाना है:
${taskLines}

नियम:
- एक छोटा, स्वाभाविक WhatsApp message लिखो जो ऐसा लगे कि विक्रम जी खुद भेज रहे हैं
- इस बार का अंदाज़: ${tone}
- नाम के साथ अभिवादन करो (जैसे राम राम / नमस्ते / जय श्री कृष्ण — variation रखो)
- काम को साफ-साफ points में लिखो
- अंत में छोटा सा सम्मानजनक sign-off
- कुल 60 शब्द से कम रखो, emoji थोड़े-बहुत ठीक हैं
- सिर्फ़ message लिखो, कोई explanation या heading नहीं, कोई quotes नहीं`;
}
